...
namespace InvetPerspectiva
{
    ...
    {
        private readonly BDClass bDClass = new BDClass();
        ...
        //{
        //    OleDbConnection conn = new OleDbConnection(bDClass.DBConnect());
        //    conn.Open();
        ...
        //    OleDbDataAdapter dataAdapter = new OleDbDataAdapter(CommandText, bDClass.DBConnect());
